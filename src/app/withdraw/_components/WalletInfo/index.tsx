...
export const WalletInfo = () => {
  ...
  const { stOlasFormattedBalance } = useOlasBalances(address, chainId);
      ...
      <div className="flex flex-col items-start mb-8">
        ...
        <div className="flex gap-3 mt-2">
          <div className="flex items-center gap-2 rounded-xl bg-[#FFFFFF0D] px-4 py-2">
            ...
            <span className="text-base font-semibold">Pending - 0</span>
          </div>
          <div className="flex items-center gap-2 rounded-xl bg-[#FFFFFF0D] px-4 py-2">
            <LuCircleCheckBig color="#00CF6B" size={20} />
            <span className="text-base font-semibold">Completed - 0</span>
          </div>
        </div>
      </div>
