...
export const Dialog = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Panel */}
      <div className="relative z-10 transform overflow-hidden rounded-2xl bg-zinc-800 text-left shadow-xl outline outline-1 -outline-offset-1 outline-white/10 transition-all w-full max-w-[500px]">
